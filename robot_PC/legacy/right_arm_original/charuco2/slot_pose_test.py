...
GRASP_POSITION_COMPENSATION_MM = {
    # 슬롯 1: 반복 집기 시험에서 X +4mm가 안정적이었다.
    1: np.array([4.0, 0.0, 0.0], dtype=np.float64),
...
def main() -> None:
    print("=" * 70)
    print("오른팔 슬롯 재현 및 슬롯 4 상공 정렬 개선 시험 v24")
    print("집기 Y gain 0.65 유지 / 상공 정렬 5mm·1회 안정 판정")
    print("=" * 70)
    ...
    print("b: 슬롯 4 그리퍼 닫기 + Z 30mm 상승 (8초 안에 두 번)")
    print("d: 원래 집기 높이로 하강 → 열기 → Z 30mm 후퇴 (8초 안에 두 번)")
    print("o: 그리퍼 단독 열기 (타이어 상승 중에는 차단)")

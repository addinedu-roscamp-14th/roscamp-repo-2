"""Validated right-arm approach/grasp sequence restored from right_arm_client.py."""
...
# ---------------------------------------------------------------------------
# Values restored from the working right_arm_client.py
# ---------------------------------------------------------------------------
...
GRASP_POSITION_COMPENSATION_MM = {
    1: np.array([17.0, 0.0, 5.0], dtype=np.float64),
    2: np.array([18.0, 0.0, 5.0], dtype=np.float64),
...
class PickSequence:
    ...
    def move_grasp(
        ...
        if (
            ...
            print(
                f"슬롯 {slot}은 X·Y 이동 시 Z가 함께 변하는 "
